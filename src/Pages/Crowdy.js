      ...
      <div className="page">
        ...
        <div className="menu-content">
          ...
          <span className="menu-content-text menu-content-paragraph-space">
            <span className="primary-color font-light">Crowdy</span>는 카페의 혼잡도를 비롯한 다양한 정보를 확인할 수 있는 카페 통합 플랫폼입니다.
          </span>
          <span className="menu-content-title menu-content-title-space">
          ...
          <span className="menu-content-text menu-content-text-space">
            앞으로도 계속해서 여러분께 편하고 실용적인 <span className="primary-color font-light">Crowdy</span> 서비스를 제공해드릴 수 있도록 노력하겠습니다.
          </span>
